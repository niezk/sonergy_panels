<template>
	<svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24">
		<g fill="none" stroke="#eeda3b" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
		...
		<circle cx="12" cy="12" r="10" mask="url(#lineMdMoonAltToSunnyOutlineLoopTransition0)" fill="#eeda3b">
